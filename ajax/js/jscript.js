...
function Global(){}
Global.GetUndefined() = {};
Global.ValueOf = function(unknown){
...
Global.ToString = function(unknown){
...
Global.IsBlank = function(unknown){
...
Global.IsJScriptType = function(unknown)
{
	switch(typeof(unknown))
	{
	case "object":
...
Global.IsJScriptObject = function(unknown)
{
...
Global.ThrowError = function(msg){
...
Object.EncodeJScript = function(v)
{
...
Object.DecodeJScript = function(s)
{
	s=String.Convert(s);
	if(s=="")return null;
...
String.ConvertArguments = function(args)
{
...
String.prototype.ToStringByZero = function(count)
{
	...
	return str;
}String.ToStringByZero = function(str,count){return String.Convert(str).ToStringByZero(count);}

//编码SQL的常规字符串
String.prototype.EncodeSQL = function()
{
	var str=this;
	str=str.replace(/\x27/g,"'\'");
	return str;
} String.EncodeSQL = function(str){return String.Convert(str).EncodeSQL();}
//用 Like 操作符时编码SQL
String.prototype.EncodeSQLLike = function()
{
	var str=this
	...
	return str;
} String.EncodeSQLLike = function(str){return String.Convert(str).EncodeSQLLike();}


//编码成VBScript字符串，两边的引号已经加了""
String.prototype.EncodeVBScript = function()
{
	var str=this;
	...
	str=str.replace(/\r/g,"");
	return "_\n\""+str+"\"";
}String.EncodeVBScript = function(str){return String.Convert(str).EncodeVBScript();}

//编码成JScript字符串,不加两边的引号
String.prototype.EncodeJScript = function()
{
	var str=this;
	...
	return str;
} String.EncodeJScript = function(str){return String.Convert(str).EncodeJScript();}

//保留换行,在服务器上解码会丢失\n
String.prototype.EncodeJScriptCode = function()
{
	var str=this;
	str=str.replace(/\x5c/g,"\\\\");
	str=str.replace(/\x2f/g,"\\/");
	...
	str=str.replace(/\r/g,"\\r");
	return str;
} String.EncodeJScriptCode = function(str){return String.Convert(str).EncodeJScriptCode();}

//保留换行,在服务器上解码会丢失\n
//特殊字符转换成\uxxxx
String.prototype.EncodeJScriptHalf = function()
{
	var str=this;
	str=str.replace(/\\/g,"\\\\");
	str=str.replace(/\x2f/g,"\\/");
	...
	str=str.replace(/\r/g,"\\r");
	return str;
} String.EncodeJScriptHalf = function(str){return String.Convert(str).EncodeJScriptHalf();}
//全部转换成\uxxxx,太慢
String.prototype.EncodeJScriptFull = function()
{
	var str=this;
	var arr=[]
	...
	return "\\u"+arr.join("\\u");
} String.EncodeJScriptFull = function(str){return String.Convert(str).EncodeJScriptFull();}
//编码HTML
String.prototype.EncodeHTML = function()
{
	...
	str=str.replace(/\x27/g,"&#39;");
	return str;
} String.EncodeHTML = function(str){return String.Convert(str).EncodeHTML();}
//换行，空格，等。。。
String.prototype.EncodeInnerHTML = function()
{
	var str=this;
	...
	str=str.replace(/\s/g,"&#160;");
	return str;
} String.EncodeInnerHTML = function(str){return String.Convert(str).EncodeInnerHTML();}
//编码HTML的属性 href="xxxx"
String.prototype.EncodeAttr = function()
{
	...
	str=String.EncodeHTML(str);
	return str;
} String.EncodeAttr = function(str){return String.Convert(str).EncodeAttr();}
//XML编码
String.prototype.EncodeXML = function()
{
	...
	str=str.replace(/\x27/g,"&#39;");
	return str;
} String.EncodeXML = function(str){return String.Convert(str).EncodeXML();}
//URL编码
String.prototype.EncodeURL = function()
{
	return Server.URLEncode(this);
} String.EncodeURL = function(str){return String.Convert(str).EncodeURL();}

 String.prototype.EasyEncode = function(key)
{
	var str=this;
	...
	return arr.join(",");
} String.EasyEncode = function(str,key){return String.Convert(str).EasyEncode(key);}

 String.prototype.EasyDecode = function(key)
{
	var str=this;
	key=String.Convert(key);
	if(key==="")return str;
	...
	return arr.join("");
} String.EasyDecode = function(str,key){return String.Convert(str).EasyDecode(key);}

//字符串操作
 String.prototype.Trim = function()
{
	return this.replace(/^\s*/g,"").replace(/\s*$/g,"");
} String.Trim = function(str){return String.Convert(str).Trim();}

 String.prototype.TrimLeft = function()
{
	return this.replace(/^\s*/g,"");
} String.TrimLeft = function(str){return String.Convert(str).TrimLeft();}

 String.prototype.TrimRight = function()
{
	return this.replace(/\s*$/g,"");
} String.TrimRight = function(str){return String.Convert(str).TrimRight();}

 String.prototype.Left = function(count)
{
	return this.substr(0,count);
} String.Left = function(str,count){return String.Convert(str).Left(count);}

 String.prototype.Right = function(count)
{
	return this.substr(this.length-count,count);
} String.Right = function(str,count){return String.Convert(str).Right(count);}

 String.prototype.RemoveBlank = function()
{
	return this.replace(/\s*/g,"");
} String.RemoveBlank = function(str){return String.Convert(str).RemoveBlank();}

 String.prototype.IsGUID = function()
{
	return /^\{[A-Fa-f0-9]{8}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{12}\}$/ig.test(this);
} String.IsGUID = function(str){return String.Convert(str).IsGUID(str);}
/****************************************************************\
	Number
\****************************************************************/
 Number.Convert = function(v,dv)
{
 ...
 Number.ConvertFloat = function(v){return Number.Convert(v)}
 Number.ConvertInt = function(v){return parseInt(Number.Convert(v))}
 Number.ConvertRound = function(v){return Math.round(Number.Convert(v))}
 Number.ConvertFloor = function(v){return Math.floor(Number.Convert(v))}
 ...
 Number.prototype.ToStringByZero = function(count)
{
	...
	while(str.length<count)str="0"+str;
	return str;
} Number.ToStringByZero = function(num,count){return Number.Convert(num).ToStringByZero(count);}

/****************************************************************\
	Boolean
\****************************************************************/
 Boolean.Convert = function(v)
{
 ...
 Boolean.ConvertFromString = function(str)
{
 ...
 Boolean.IsFalse = function(v)
{
 ...
 Boolean.prototype.ToCNString = function()
{
	return this.valueOf()?"是":"否";
} Boolean.ToCNString = function(b){return Boolean.Convert(b).ToCNString();}

 Boolean.prototype.ToString = function()
{
	return this.valueOf()?"true":"false";
} Boolean.ToString = function(b){return Boolean.Convert(b).ToString();}
/****************************************************************\
	Array
\****************************************************************/
 Array.ConvertArguments = function(args)
{
	if(typeof(args)!="object")
	{
